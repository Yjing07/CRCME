...
def create_clinical_report(datas, save_path="clinical_report_final.pdf"):
    ...
    api_key = "if57-Br3ptcwyiaVZuemXXSpz8CXKKhFJWeFmYSk-rvZq2r5dRO_lkTrG1AMzkqNzMNuMgrSV9pOCMBu1I6qpQ"   #TODO
    headers = {
        'Content-Type': 'application/json',
        'Authorization': f'Bearer {api_key}'
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_root', type=str, default='/cache/yangjing/main_files/CRCFound2/datas/all_CT/data/crop_256_32/image/20130124_203683.nii.gz')
    parser.add_argument('--Patient_ID', type=str, default="p00001")
